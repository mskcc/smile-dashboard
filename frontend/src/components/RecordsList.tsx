...
const RecordsList = forwardRef<Ref, IRecordsListProps>(
  (
    {
      lazyRecordsQuery,
      nodeName,
      ...
      <Container fluid>
        ...
        {showClosingWarning && (
          ...
          >
            ...
            <Modal.Body>
              <p>
                You have unsaved changes. Are you sure you want to exit this
                view?
              </p>
            </Modal.Body>
            <Modal.Footer>
            ...
            <Tooltip
              title={
                <span style={{ fontSize: 12 }}>
                  ...
                  or press &quot;Enter&quot; to get your results. To bulk
                  search, input a list of values separated by spaces or commas
