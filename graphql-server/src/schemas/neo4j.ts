...
export async function buildNeo4jDbSchema() {
  ...
  const extendedTypeDefs = gql`
    ...
    type Query {
      sampleDashboardQuery: [SampleDashboardRow]
    }
        ...
        try {
          ...
          const sampleDashboardRows = result.records.map((record) => {
            ...
            return {
              ...
              lastUpdated: mostRecentMetadata.properties.importDate,
              ...
              sampleClass: mostRecentMetadata.properties.sampleClass,
